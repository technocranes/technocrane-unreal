 ...
 * within this plugin.
 */
class ITechnocranePlugin : public IModuleInterface
{
...
public:
	 ...
	 */
	static inline ITechnocranePlugin& Get()
	{
		return FModuleManager::LoadModuleChecked< ITechnocranePlugin >( "TechnocranePlugin" );
	}
